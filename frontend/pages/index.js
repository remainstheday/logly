            ...
            <main>
                ...
                <section className="container mt-4 px-4 mt-10 mx-auto">
                    ...
                    <div className="w-full mt-4">
                        ...
                        <Link href={`/experiences`} passHref>See all experiences +</Link>
                    </div>
                </section>
                ...
                <section className="container mt-4 px-4 mt-10 mx-auto">
                    ...
                    <hr/>
                    <div className="w-full mt-4">
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Accusantium alias aut autem
                            blanditiis consectetur doloribus eius eos, et ipsam itaque laboriosam magnam minus
                            molestiae, numquam, officiis possimus provident sed. Ipsam.</p>
                        <Link href={`/`} passHref>Discover Art Social +</Link>
                    </div>
                </section>
