...
CREATE TABLE "SiteContent" (
    ...
    "name" TEXT NOT NULL DEFAULT E'',
    "title" TEXT NOT NULL DEFAULT E'',
    "siteLogo" TEXT NOT NULL DEFAULT E'',
    "logoWidth" TEXT NOT NULL DEFAULT E'',
    "logoHeight" TEXT NOT NULL DEFAULT E'',
...
-- AddForeignKey
ALTER TABLE "_Artifact_relatedExperiences" ADD CONSTRAINT "_Artifact_relatedExperiences_A_fkey" FOREIGN KEY ("A") REFERENCES "Artifact"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "_Artifact_relatedExperiences" ADD CONSTRAINT "_Artifact_relatedExperiences_B_fkey" FOREIGN KEY ("B") REFERENCES "Experience"("id") ON DELETE CASCADE ON UPDATE CASCADE;
