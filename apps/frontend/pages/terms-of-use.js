    ...
    <>
      ...
      <div className="max-w-4xl mx-auto min-h-screen md:mx-auto">
        <Section>
          ...
          <h3 className="text-2xl bold mt-6 mb-2">3. USER REPRESENTATIONS </h3>
          <p>
          ...
          <h3 className="text-2xl bold mt-6 mb-2"> 4. USER REGISTRATION</h3>
          <p>
          ...
          <h3 className="text-2xl bold mt-6 mb-2">5. FEES AND PAYMENT</h3>
          <p>
          ...
          <h3 className="text-2xl bold mt-6 mb-2">6. CANCELLATION </h3>
          <p>
          ...
          <h3 className="text-2xl bold mt-6 mb-2">7. PROHIBITED ACTIVITIES</h3>
          <p>
            {" "}
          ...
          <h3 className="text-2xl bold mt-6 mb-2"> 9. CONTRIBUTION LICENSE</h3>
          <p>
          ...
          <h3 className="text-2xl bold mt-6 mb-2">10. SUBMISSIONS</h3>
          <p>
          ...
          <h3 className="text-2xl bold mt-6 mb-2">13. SITE MANAGEMENT</h3>{" "}
          <p>
          ...
          <h3 className="text-2xl bold mt-6 mb-2">14. PRIVACY POLICY</h3>{" "}
          <p>
            We care about data privacy and security. Please review our Privacy
            Policy: https://logly.world/privacy-policy. By using the Site, you
          ...
          <h3 className="text-2xl bold mt-6 mb-2">16. TERM AND TERMINATION</h3>{" "}
          <p>
          ...
          <h3 className="text-2xl bold mt-6 mb-2">18. GOVERNING LAW</h3>
          <p>
            These Terms of Use and your use of the Site are governed by and
            construed in accordance with the laws of the State of Oklahoma
            applicable to agreements made and to be entirely performed within
            the State of Oklahoma, without regard to its conflict of law
            principles.
          </p>
          ...
          <h3 className="text-2xl bold mt-6 mb-2">20. CORRECTIONS</h3>
          <p>
          ...
          <h3 className="text-2xl bold mt-6 mb-2">21. DISCLAIMER</h3>{" "}
          <p>
          ...
          <h3 className="text-2xl bold mt-6 mb-2">23. INDEMNIFICATION</h3>{" "}
          <p>
          ...
          <h3 className="text-2xl bold mt-6 mb-2">24. USER DATA</h3>
          <p>
          ...
          <h3 className="text-2xl bold mt-6 mb-2">27. MISCELLANEOUS</h3>
          <p>
          ...
          <h3 className="text-2xl bold mt-6 mb-2">28. CONTACT US </h3>
          <p>
